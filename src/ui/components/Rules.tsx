    ...
    <div className="w-full h-[430px] flex justify-between gap-10 items-center">
      ...
      <div className="w-full flex flex-col justify-center items-center gap-7">
        ...
        <div className="w-full flex flex-col py-3 gap-3">
          <Button variant='outline' className="w-full border-none hover:bg-transparent" type="button" onClick={() => changeActiveRuleAction(0)}>
        ...
        <div className="w-full flex flex-col py-3 gap-3">
          <Button variant='outline' className="w-full border-none hover:bg-transparent" type="button" onClick={() => changeActiveRuleAction(1)}>
            <h4 className="w-full flex justify-start items-start text-xl">
        ...
        <div className="w-full flex flex-col py-3 gap-3">
          <Button variant='outline' className="w-full border-none hover:bg-transparent" type="button" onClick={() => changeActiveRuleAction(2)}>
            <h4 className="w-full flex justify-start items-start text-xl">
