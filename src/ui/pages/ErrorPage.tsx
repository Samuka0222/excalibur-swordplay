  ...
  return (
    <section className="min-w-full min-h-screen px-5 py-6 bg-white flex flex-col justify-center items-center">
      ...
      <motion.div
        ...
        className="mt-6"
      >
        <Link to="/" className="text-white bg-primary font-medium text-lg w-[200px] rounded-lg py-2 transition-colors hover:text-primary hover:bg-secondary flex justify-center items-center mb-16">
          Voltar ao Início
        </Link>
      </motion.div>
    </section>
