...
import { BicepsFlexed, Calendar, Check, Mail, Scroll, ShieldBanIcon, Sword, Swords, User } from "lucide-react";
        ...
        >
          <HeroSection className="w-full flex flex-col justify-center items-center px-5 md:px-0 gap-24 py-20" background="white">
            <div className="w-full md:w-[85%] lg:w-[75%] xl:w-[50%] flex flex-col justify-center">
              ...
              <div className="w-full flex flex-col md:flex-row justify-center items-center gap-4 md:gap-0 xl:gap-8 text-white mt-8">
